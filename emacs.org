...
* Configuring Emacs:
  ...
  chance. This template was lifted from [[http://zeekat.nl/articles/making-emacs-work-for-me.html][Making Emacs work for me]
  I have removed some parts of it that either I didn't think I would
  need or didn't understand.

* How to use this configuration

** TODO Obtaining the source
...
** TODO Installation procedure
  ...
  - Clone [[https://github.com/mblunk/SOMETHINGHERE][the repository]] as ~$HOME/.emacs.d~ (or symlink it to that
    directory).
