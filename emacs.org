...
** TODO Python
   ...
   #+begin_src emacs-lisp
     ...
     (setq jedi:server-command '("python" "/Users/x289/.emacs.d/.cask/24.4.1/elpa/jedi-20140321.1323/jediepcserver.py"))
...
** TODO Backups
   ...
   #+begin_src emacs-lisp
     (setq
      ...
      kept-old-versions 2
      version-control t)
     (setq backup-directory-alist '(("" . "~/.emacs.d/backup/persave")))
   #+end_src
* Org Mode
** Global keys
