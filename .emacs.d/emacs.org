...
NOTE: lsp has markdown as a dependent so we need to remap it
here. Once we remove lsp we should be able to remove this
...
#+BEGIN_SRC emacs-lisp
  (use-package flycheck
    ...
    :hook ((python-ts-mode Texinfo-mode c-ts-mode c++-ts-mode emacs-lisp-mode)
  ...
  (add-to-list 'exec-path
               (concat (getenv "HOME") "/miniconda3/envs/cmake-lsp/bin"))
  ...
  (with-eval-after-load 'eglot
    (add-to-list 'eglot-server-programs
                 ...
                 '(cmake-ts-mode . ((concat (getenv "HOME") "/miniconda3/envs/cmake-lsp/bin/cmake-language-server")))
                                          ;                 '(yaml-ts-mode . ((concat (getenv "HOME") "/miniconda3/envs/cmake-lsp/bin/cmake-language-server")))
                 ;; TODO: sh-mode, python-mode
                                          ;                 '(bash-ts-mode . ((concat (getenv "HOME") "/.npm-global/bin/bash-language-server" "start")))
                                          ;                 '(python-ts-mode . ((concat (getenv "HOME") "/miniconda3/envs/cmake-lsp/bin/python-lsp-server")))
