...
#+begin_src sh
  ...
  pip install cpplint
  chmod +x ~/.virtualenvs/cpplint/lib/python3.7/site-packages/cpplint.py
...
#+begin_src emacs-lisp
  ...
  (custom-set-variables
   '(flycheck-c/c++-googlelint-executable "~/.virtualenvs/cpplint/lib/python3.7/site-packages/cpplint.py"))
  ...
  (setq-default flycheck-disabled-checkers '(c/c++-gcc c/c++-cppcheck))
  (add-hook 'c++-mode-hook #'flycheck-mode)
