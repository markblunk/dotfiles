...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/lsp ()
    "Prevent lsp from running in wizpl-mode, a derivative of haskell mode."
    (unless (eq major-mode 'wizpl-mode)
      (lsp)))
  ...
  (use-package lsp-haskell
    ...
    :init
    (add-hook 'hack-local-variables-hook
              (lambda () (when (derived-mode-p 'haskell-mode)) (my/lsp)))
    )
  ;; this doesn't load correctly inside use-package so it's stuck out here for now.
  (add-hook 'haskell-mode-hook #'my/lsp)
#+END_SRC
